 ...
 * Gestiona las rutas del portal del veterinario (CRUD de mascotas y
 * clientes, tratamientos y ficha clínica). Un controlador por lógica
 * de portal: las rutas del cliente viven en ClienteController y el
 * flujo público (login) en HomeController, de modo que cada
 ...
 * reglas (dueño obligatorio, estado Activo, stock de drogas, cascada
 * de borrado) viven en la capa Service, que las comunica lanzando
 ...
 * con ellas: muestra el panel informativo o regresa al formulario.
 *
...
public class VeterinarioController {
    ...
    /** Servicio de dueños (CRUD de clientes desde el portal vet). */
    @Autowired
     ...
     * veterinario: Spring no puede convertirlos a Integer y lanzaría un
     * 400; en su lugar se renderiza el panel informativo de la ficha.
